...
if(post_password_required()){
	...
	if($theme === 'bricks'){
		$args = array(
			...
			'proofing'               => get_post_meta( $id, '_proofing', true ),
			'lightbox'               => get_post_meta( $id, '_bricks_lightbox', true ),
			...
			'socials'                => get_post_meta( $id, 'sharing_disabled', true) !== '1' ? 'on' : 'off',
			'proportion'             => get_post_meta( $id, '_bricks_proportions_size', true),
			'margin'                 => get_post_meta( $id, '_brick_margin', true ),
